package com.android.vstecs.eshop.views.ptrgridview;
...
import com.vstecs.android.uiframework.pulltorefresh.ILoadingLayout.State;
...
public class PullToRefreshGridViewWithHeaderAndFooter extends
        PullToRefreshBase<GridViewWithHeaderAndFooter> implements OnScrollListener {
    ...
    @Override
    protected GridViewWithHeaderAndFooter createRefreshableView(Context context, AttributeSet attrs) {
        GridViewWithHeaderAndFooter gridView = new GridViewWithHeaderAndFooter(context);
        mGridView = gridView;
