...
//    public TitleBarHelper(View layouts, int leftStrId, int rightStrId, int titleStrId) {
//        mActivity = null;
//        left = (TextView) layouts.findViewById(R.id.left);
...
////            }
////        }
//        right = (TextView) layouts.findViewById(R.id.right);
//        setRightMsg(rightStrId);
//        rightImg = (ImageView) layouts.findViewById(R.id.title_right_iv);
//        title = (TextView) layouts.findViewById(R.id.title);
//        setTitleMsg(titleStrId);
//    }
